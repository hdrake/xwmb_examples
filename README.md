...
Download all netcdf files in [https://zenodo.org/records/18469910] and place them in the data/ directory.
...
You should be able to get the package and all its dependencies through pip:
```
pip install xwmb==0.5.5
```
Then, simply run a Jupyter session and start experimenting with the notebook of your choice. 
